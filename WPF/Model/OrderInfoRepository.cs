...
namespace MasterDetailsViewDemo
{
    public class OrderInfoRepository
    {
        ...
        {
            get { return this.CustomerID.ToList(); }
        }

        public List<string> ShipCountries
        {
            get { return this.ShipCountry.ToList(); }
        }
        ...
        private List<OrderDetails> ord = new List<OrderDetails>();
        ...
        private void SetShipCity()
        {
            ...
            {
                "Aachen", "Berlin", "Brandenburg", "Cunewalde", "Frankfurt a.M.", "Köln", "Leipzig", "Mannheim", "München",
                "Münster", "Stuttgart"
            };
            ...
            {
                "Albuquerque", "Anchorage", "Boise", "Butte", "Elgin", "Eugene", "Kirkland", "Lander", "Portland",
                "San Francisco", "Seattle", "Walla Walla"
            };
